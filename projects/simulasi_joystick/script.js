...
document.addEventListener('DOMContentLoaded', function() {
  ...
  console.log('Elements found:', {
    ...
    btnMobile: !!btnMobile,
    btnShowGame: !!btnShowGame,
    btnBackSimulator: !!btnBackSimulator
  });
  ...
  createGameJoystick('mini-joystick1', false);
  createGameJoystick('mini-joystick2', false);
  createGameJoystick('mini-joystick3', true);
  createGameJoystick('mini-joystick4', false);
